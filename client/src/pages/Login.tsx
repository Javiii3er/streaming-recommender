  ...
  return (
    <div className="min-h-screen bg-neutral-950 flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        ...
        {/* Logo clickeable — vuelve a la landing */}
        <div className="text-center mb-8">
          ...
          <p className="text-neutral-400 mt-2 font-body">Bienvenido de vuelta</p>
        </div>

        {/* Card */}
        <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-8 space-y-5">
          <div className="flex items-center justify-between">
            <h2 className="font-display font-bold text-white text-xl">Iniciar sesión</h2>
            <button
              onClick={() => navigate('/')}
